...
*/
#define USB_CFG_VENDOR_NAME     'P', 'R', '0', 'B', '0', 'A', 'R', 'D','-','R', 'i', 'p', 'p', 'e', 'r', '1', '2', '1', '@', 'g', 'm', 'a', 'i', 'l', '.', 'c', 'o', 'm'
...
* protocol.
*/
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH    173  /* total length of report descriptor */
