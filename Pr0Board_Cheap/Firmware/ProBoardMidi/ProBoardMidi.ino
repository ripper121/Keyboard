...
const uint8_t button1 = KEY_S_1;

const uint8_t button2 = KEY_S_2;

const uint8_t button3 = KEY_S_3;

const uint8_t button4 = KEY_S_4;

const uint8_t button5 = KEY_S_5;

const uint8_t button6 = KEY_S_6;

const uint8_t button7 = KEY_S_7;

const uint8_t button8 = KEY_S_8;

const uint8_t buttons[NUM_BUTTONS] = {button1, button2, button3, button4, button5, button6, button7, button8};

const byte notePitches[NUM_BUTTONS] = {C3, D3, E3, F3, G3, A3, B3, B2};
